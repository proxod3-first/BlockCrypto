...
document.getElementsByClassName("tab-btn")[0].onclick = function () {
  ...
  document.getElementById("other_crypto").hidden = true;
  document.getElementById("top_crypto").hidden = false;
};

document.getElementsByClassName("tab-btn")[1].onclick = function () {
  ...
  document.getElementById("other_crypto").hidden = false;
  document.getElementById("top_crypto").hidden = true;
};
